...
//产损最小策略（完美维修）
public class MinimalLost2Policy {
    ...
    public static void main(String[] args) {
        ...
        for (int z = 0; z < stationsNum; z++) {
           // EasyExcel.write("F:\\data\\policydata\\MaximizeAvailability\\"+"设备"+(z+1)+"FailureRates.xlsx",com.Jarvis.MaxPlusMaintenance.demo_maintenance.entity.FailureRate.class).withTemplate("F:\\data\\data.xlsx").sheet("sheet1").doWrite(list[z]);
        }
        ...
        EasyExcel.write("E:\\论文草稿\\MPC\\MinLoss2.xlsx",com.Jarvis.MaxPlusMaintenance.demo_maintenance.entity.data.class).withTemplate("E:\\论文草稿\\MPC\\data.xlsx").sheet("sheet1").doWrite(Finaldata);
